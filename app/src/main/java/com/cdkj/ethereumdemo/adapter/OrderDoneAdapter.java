...
public class OrderDoneAdapter extends BaseQuickAdapter<OrderDetailModel, BaseViewHolder> {

    public OrderDoneAdapter(@Nullable List<OrderDetailModel> data) {
    ...
    protected void convert(BaseViewHolder helper, OrderDetailModel item) {
        ...
        if (item.getBuyUser().equals(SPUtilHelper.getUserId())) { // 自己是买家
