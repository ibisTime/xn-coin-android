...
import com.cdkj.ethereumdemo.wallet.account.BillActivity;
import com.cdkj.ethereumdemo.wallet.account.RechargeActivity;
import com.cdkj.ethereumdemo.wallet.account.WithdrawActivity;
...
public class CoinAdapter extends BaseQuickAdapter<CoinModel.AccountListBean, BaseViewHolder> {
    ...
    protected void convert(BaseViewHolder helper, CoinModel.AccountListBean item) {
        switch (item.getCurrency()){
            ...
            case "ETH":
                helper.setText(R.id.tv_name, StringUtil.getStirng(R.string.property_eth));
