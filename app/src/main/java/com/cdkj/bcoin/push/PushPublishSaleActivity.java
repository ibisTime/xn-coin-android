...
import com.cdkj.bcoin.databinding.ActivityPushPublishSaleBinding;
...
public class PushPublishSaleActivity extends AbsBaseActivity {

    private ActivityPushPublishSaleBinding mBinding;
    ...
    public View addMainView() {
        mBinding = DataBindingUtil.inflate(LayoutInflater.from(this), R.layout.activity_push_publish_sale, null, false);
