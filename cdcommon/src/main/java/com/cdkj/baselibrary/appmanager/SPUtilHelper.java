...
//		return SPUtils.getString(BaseApplication.getContext(),BUILD_TYPE_KEY, BUILD_TYPE_TEST);
        return SPUtils.getString(BaseApplication.getContext(), BUILD_TYPE_KEY, "");
    }
     ...
     * @param zfbAccount
     */
    public static void saveZfbAccount(String zfbAccount) {
        SPUtils.put(BaseApplication.getContext(), "zfbAccount", zfbAccount);
    }
    ...
    public static String getZfbAccount() {
        return SPUtils.getString(BaseApplication.getContext(), "zfbAccount", "");
    }
     ...
     * @param zfbQr
     */
    public static void saveZfbQr(String zfbQr) {
        SPUtils.put(BaseApplication.getContext(), "zfbQr", zfbQr);
    }

    /**
     * 获取支付宝收款码
     */
    public static String getZfbQr() {
        return SPUtils.getString(BaseApplication.getContext(), "zfbQr", "");
    }
